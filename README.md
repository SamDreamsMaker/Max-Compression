...
| File | Size | gzip -9 | bzip2 -9 | xz -9 | **MCX L9** | **MCX L12** | **MCX L20** | vs bzip2 | vs xz |
|------|------|---------|----------|-------|-----------|------------|-------------|----------|-------|
| dickens | 10 MB | 2.65× | 3.64× | 3.60× | 2.34× | **4.07×** | **4.07×** 🏆 | +12% | +13% |
| xml | 5 MB | 8.07× | 12.12× | 11.79× | **6.69×** | **12.86×** | **12.86×** 🏆 | +6% | +9% |
